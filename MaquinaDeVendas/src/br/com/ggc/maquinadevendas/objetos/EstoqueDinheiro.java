...
public class EstoqueDinheiro {
	...
	public String liberarProduto(Produto _produto){
		...
		produtoLiberado.append("Valor de compra: " + String.format("R$ %10.2f",_produto.getValor_Produto())+ "\n");
		return produtoLiberado.toString();
	}
	
	//Esse metodo tem como objetivo acionar a libeção fisica de dinheiro da maquina
